...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Routewise',
      theme: ThemeData(scaffoldBackgroundColor: const Color(0xFF070C16)),
        ...
        child: TweenAnimationBuilder<double>(
          ...
          onEnd: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => MyHomePage(title: 'Routewise Login'),
              ),
            );
          },
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  ...
                  borderSide: const BorderSide(color: Color(0xFF303747)),
                ),
              ),
            ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: const BorderSide(color: Color(0xFF303747)),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(7),
                      ),
                    ),
